        ...
        GeometryReader{ geometry in
            ZStack{
                ...
                VStack{
                    ...
                    VStack {
                        Spacer()
                        NavigationLink(destination: GameMatchView(selectedImage: selectedImages[selectedIndex]), isActive: $navigationToGame) {
                            EmptyView()
                        }
                        Button(action: {
                            selectedIndex = Int.random(in: 0..<selectedImages.count)
